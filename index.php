...
<html>
    ...
    <body style="background-color:whitesmoke;">
       <?php require_once 'merge.php'; ?>
       <form action="merge.php" method="POST">
      
    <h1 style="color:blue;position:relative; left:-5px; top:48px;">
...
<div class="range-wrap" style="width: 30%;" >
  ...
  <h2 style="color:blue;position:relative; left:-5px; top:48px;">
...
<div class="range-wrap" style="width: 30%;">
  ...
  <h3 style="color:blue ;position:relative; left:-5px; top:48px;">
...
<div class="range-wrap" style="width: 30%;">
  ...
  <h4 style="color:blue;position:relative; left:-5px; top:48px;">
...
<div class="range-wrap" style="width: 30%;">
  ...
  <h5 style="color:blue;position:relative; left:-5px; top:48px;">
...
<div class="range-wrap" style="width: 30%;">
  ...
  <h6 style="color:blue;position:relative; left:-5px; top:48px;">
